...
// Include the statistics decoder utility functions
require_once(dirname(__FILE__) . '/statistics_decoder_utils.php');
...
function display_enhanced_analytics_shortcode($atts) {
  ...
  // Use the utility function to safely decode the statistics data
